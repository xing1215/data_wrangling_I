...
that as the first argument of the next function call

when the result of one function call is not the first argument of the
next call, that is the point you have to worry and think about. But dont
